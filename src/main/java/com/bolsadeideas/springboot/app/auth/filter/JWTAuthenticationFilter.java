...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	SecretKey secretKey = Keys.hmacShaKeyFor("Clave!#$%&/()Secreta.//1234.4321.//.abcd.dcba.1a.2b.3c.4d.12345678".getBytes());
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		if(username != null && password != null) {
			logger.info("Username desdes request parameter (form-data): "+username);
			logger.info("Password desdes request parameter (form-data): "+password);
		}else{
			Usuario user = null;
			try {
